...
export const RetryIndexSchema = z.union([
  z.literal(0),
  z.literal(1),
  z.literal(2),
]);
...
export const HarnessAttemptSchema = z
  .object({
    attemptId: NonEmpty,
    taskId: NonEmpty,
...
export const HarnessDeliverySchema = z.discriminatedUnion("kind", [
  z
    ...
    .strict(),
  z
    .object({ kind: z.literal("idle"), nextCursor: NonEmpty.optional() })
    .strict(),
  z
    .object({ kind: z.literal("closed"), nextCursor: NonEmpty.optional() })
    .strict(),
]);
