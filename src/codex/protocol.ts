...
export const ReviewStartResponseSchema = z
  .object({
...
export const ThreadHistoryTurnSchema = z
  .object({
    id: NonEmpty,
...
const CommandExecutionRequestApprovalSchema = z
  .object({
...
const FileChangeRequestApprovalSchema = z
  .object({
...
const PermissionsRequestApprovalSchema = z
  .object({
...
const ToolRequestUserInputSchema = z
  .object({
...
const McpServerElicitationRequestSchema = z
  .object({
...
export function classifyCodexTurnFailure(
  ...
  if (info && typeof info === "object") {
    ...
    const httpStatus =
      typeof connection?.httpStatusCode === "number"
